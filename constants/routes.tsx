...
export const routes: RouteStore[] = [
  // Color Screens
  {
    ...
    tip: {
      title: "white screen",
      content: {
        "white screen to copy drawings": "I needed to have something bright under a paper, so i could redraw a image easier.",
        "white screen as a light source": "Lighting up the back of a lightbox for product photography",
        "white screen to check monitor": "Check your monitor and find dead pixels.",
        "white screen to blank screen": "Don't want to be distrupted? Want to take a brake? Use a white screen to blank your screen.",
        "white screen as a light to read": "To get a source of light and be able to read books when it's dark in the room and the light switch is too far away.",
        "white screen as a light to makeup": "As a bright light source for doing makeup or taking pictures",
        "white screen to clean monitor": "Silly, but I use it for monitor cleaning. It makes things on the screen obvious. :) I also use it to validate plain colour reproduction for different monitors, but that only comes up rarely and I'm not looking for professional colour grading.",
        "white screen to look for dust": "Consistent backdrop to clean my monitor on, and also to check for dead/stuck pixels. Also sometimes for lighting my face when I'm using a webcam.",
        "white screen to catch flies": "I was catching little flies as they were attracted to white screen on my display",
        "white screen to make a flipbook": "I'm working on a animated sequence, and i'm doing it the traditional way (by hand), so i need a white surface with light that allows me to put one piece of paper over another and be able to see both, so since i don't have a professional screen for this, i'm using my computer and putting the white screen on it so i don't touch anything by mistake",
        "white screen to focus yourself": "While studying, I use 2 screens, one with a timer and one to search whatever I need on the internet. When I am not searching, I put the white screen so I don't get distracted with anything on the computer",
        "white screen to configure your monitor settings": "Useful when adjusting settings in my secondary monitor (since it's quite old it doesn't just set stuff how it should be by default). Settings like vertical/horizontal position and vertical/horizontal scale. Also useful when searching for dead pixels.",
        "white screen to draw at night": "If I'm drawing on paper, I can put paper on top of my display drawing tablet and see what I'm drawing at night",
        "White Screen for Lighting": "Turn your display into a simple and efficient light source with our white screen tool. Perfect for video calls or photography where extra lighting is needed.",
        "White Screen for Visual Purity": "Experience a pure, clean and soothing visual environment using our full-screen white display. Ideal for relaxing, meditating or focusing on tasks without visual distractions.",
        "White Screen for Design Work": "Utilize our white screen tool as a blank canvas for design, drawing or any creative activities. A blank white screen allows your creativity to flow unimpeded.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "black screen",
      content: {
        "black screen to make second monitor dark without turning it off": "Quickly make second monitor dark without turning it off when playin some atmospheric game or watching some movie that turned out to be worth of doing so.",
        "black screen to save electricity": "Trying to save electricity, reduce carbon emission.",
        "black screen to hide fact computer is active": "To put on my 4 monitors when I go to sleep, instead of putting them to sleep.",
        "black screen to clean monitor": "Easier to see spots when I'm wiping off my screen",
        "black screen to make a dark background": "Background for a game. Screen is too big, 3440x1440. Don't like to play it that big, so i do 2560x1440. Need black bezels at both sides.",
        "black screen to help prevent burn in plasma TV": "I have an old plasma TV. I don't have computer speakers so when I want to play music loud, I turn on my TV and hook it up via HDMI. Plasma's are highly susceptible to burn-in so rather than leaving Windows Media Player or whatever on the screen, I use black screen to help prevent burn in. I've used various websites. But they don't seem to stay online for very long.",
        "black screen to concentrate while studying": "To not turn off my screen and concentrate while studying. Well my screen is very bright and it doesnt help with concentration, a black screen fixes that.",
        ...
        "Black Screen for Focus and Minimalism": "Embrace minimalism and reduce distractions with our black screen tool. Ideal for focus-driven tasks or for individuals practicing digital minimalism.",
        "Black Screen for Power-Saving": "Take advantage of our black screen tool as a power-saving solution for OLED and AMOLED displays. Displaying black pixels can contribute to battery conservation.",
        "Black Screen for Digital Artwork": "Artists can use our full-screen black display as a canvas for creating striking contrast in digital artwork. Black backgrounds can enhance the depth and intensity of colors.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "red screen",
      content: {
        "Red Screen for Film and Photography": "Utilize our red screen to experiment with color filters and effects in film and photography. The vibrant red background can add a dramatic touch to your compositions.",
        "Red Display for Eye Health": "Our red screen tool can be used to decrease the impact of blue light, aiding in eye comfort and health, particularly in low light conditions or before sleep.",
        "Red Screen for Virtual Events": "Create a captivating virtual event environment with our full-screen red display. It can set a distinctive tone and mood for your gatherings.",
        "Red Screen for Graphic Design": "Graphic designers can leverage our red screen tool to create bold and impactful designs. The color red can evoke strong emotions and grab viewer's attention.",
        "Red Screen for Thematic Presentations": "Educators and presenters can use our red screen to create thematic presentations, highlighting important points and capturing the audience's interest.",
        "bright red screen to make tiktoks": "Because I have blue LED lights on and it matches perfectly making my face or a part of my face red and leaving the blue lights behind me. I liked the red screen tbh, it's cool to make tiktoks or like photos and edit them to make them look professional.",
        "red light screen for online calls": "For colorcast correction when using Google Meets.",
        "red screen to preserve night vision": "Not hard on the eyes, especially when coming out of a dark area",
  ...
  },
  {
    ...
    tip: {
      title: "green screen",
      content: {
        "Green Screen for Video Content Creation": "Leverage our full-screen green display to create professional-quality videos. The green screen is perfect for video effects and post-production editing.",
        "Soothing Visual Experience with Green Display": "Use our green screen tool to create a calming visual environment. The soothing hues of green can help reduce eye strain and promote relaxation.",
        "Green Screen for Immersive Gaming Experience": "Enhance your gaming experience with our full-screen green display. It can serve as a dynamic background for a more immersive gaming environment.",
        "Green Screen for Virtual Meetings": "Utilize our green screen tool to add professional backgrounds during your virtual meetings. It can significantly improve the quality of your video calls.",
        "Green Screen as Teaching Aid": "Educators can use our green screen tool to make online teaching more interactive and engaging. It's a great way to illustrate complex concepts visually.",
        "green screen to photoshop": "Photoshop myself in my room so when i take it down and im still in my room people are like oh wow for a few seconds which makes me happy because am in a way the wow factor of those few seconds of their lives.",
        "green screen to relax": "In a class room situation, while pausing computer work and listening to others. Green, because it is the most relaxing of the colours. It is just a silent, motionless green colour, the colour of trees and grass. Thanks to it, the screen emits some green, relaxing light during computer work pauses.",
        "green screen for online calls": "For adding a green glow during meeting.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "blue screen",
      content: {
        "Relaxation with Blue Screen Display": "Discover the soothing power of our full-screen blue display. Its calming blue tones can help reduce stress and promote relaxation after a long day.",
        "Aid for Sleep with Blue Screen Tool": "Our blue screen tool can be used as a sleep aid. The soft, calming blue light is known to encourage sleepiness and improve your sleep quality.",
        "Blue Light Filter for Digital Eye Strain": "Use our full-screen blue display as a blue light filter to alleviate digital eye strain. Ideal for long hours of screen time, it can help maintain your eye health.",
        "Blue Screen as Visual Aid in Presentations": "Use our blue screen tool as a visual aid in presentations. The blue background can help emphasize text and images, enhancing communication and comprehension.",
        "blue screen to make videos": "Because my YouTube videos are better with a blue screen & because green screens are overrated",
  ...
  },
  {
    ...
    tip: {
      title: "yellow screen",
      content: {
        "Versatile Yellow Background for Content": "Immerse your audience in a warm and inviting environment with a full-screen yellow display. Ideal for injecting energy and positivity into your online content, virtual classes, or live streams.",
        "Yellow Screen for Eye Comfort": "Improve visual comfort with a yellow tinted screen. Use our tool to reduce eye strain from blue light, especially during night-time browsing or long working hours.",
        "Creative Mood Board Starter": "Kick-start your creative projects with a yellow mood board. Our full-screen yellow display can help inspire creative thinking and design concepts.",
        "Device Screen Testing": "Test the color accuracy of your display device with a full-screen yellow output. It's a handy tool for fine-tuning the color settings of monitors, tablets, or smartphones.",
        "Interactive Teaching Aid": "Use a full-screen yellow display as a teaching aid in virtual classrooms. It can serve as an engaging background to present learning materials, highlight information, and draw student attention.",
        "yellow screen to make a vibe": "I like the vibe it gives",
        "yellow screen to copy image": "To copy an image my classmate drew",
        "yellow screen to make videos": "Because my YouTube videos are better with a yellow screen & because green screens are overrated",
        "yellow screen for online calls": "For adding a yellow glow during meeting.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "orange screen",
      content: {
        "Full-Screen Orange for Virtual Backgrounds": "Use our tool to generate a lively orange screen, perfect for virtual backgrounds during online meetings, webinars, or virtual social gatherings. A splash of color to liven up your digital interactions.",
        "Orange Screen for Calming Sleep Aid": "Benefit from the calming and soothing effects of an orange display. Reduce the harsh blue light and create a sleep-friendly environment for browsing or reading before bedtime.",
        "Creative Project Inspiration with Orange": "Spark creativity with a vibrant full-screen orange display. Ideal for inspiring design projects, arts and crafts, or kick-starting your creative process.",
        "Device Display Calibration with Orange Screen": "Verify the color rendering of your digital displays with an orange full-screen output. It's an essential tool for those seeking to fine-tune their device color settings for graphic design or photo editing.",
        "Interactive Orange Learning Tool": "Utilize a full-screen orange display as a dynamic visual aid for teaching. The bold color can highlight key information, making e-learning more engaging and impactful.",
        "Orange Screen to Make a Vibe": "I like the vibe orange gives",
        "Orange Screen to Copy Image": "To copy an image my classmate drew",
        "Orange Screen to Make Videos": "Because my YouTube videos are better with a orange screen",
        "Orange Screen for Online Calls": "For adding a orange glow during meeting.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "pink screen",
      content: {
        "Pink Background for Content Creation": "Effortlessly achieve a pink backdrop for your online content creation. This tool offers a full-screen pink display that is perfect for adding a vibrant pop of color to your videos, livestreams, and virtual presentations.",
        "Easy Pink Light Therapy": "Transform your screen into a therapeutic pink light source. Benefit from the soothing effects of pink light therapy right from your device's screen. Ideal for relaxation, mood enhancement, and stress reduction.",
        "Visual Design Inspiration": "Inspire your design creativity with a full-screen pink canvas. Our tool allows designers to immerse themselves in the color pink, stimulating creative ideas for design projects.",
        "Color Calibration Testing": "Evaluate your screen's color accuracy with our tool's pink display. Perfect for checking the fidelity of the pink hue on different devices and screen settings.",
        "Attention-Grabbing Display": "Grab attention with a full-screen pink display during online presentations, webinars, or virtual meetings. Use our tool to emphasize key moments and engage your audience in a unique way.",
        "Pink Screen to Make a Vibe": "I like the vibe pink gives",
        "Pink Screen to Copy Image": "To copy an image my classmate drew",
        "Pink Screen to Make Videos": "Because my YouTube videos are better with a pink screen",
  ...
  },
  {
    ...
    tip: {
      title: "purple screen",
      content: {
        "Full-Screen Purple for Wellness Apps": "Integrate our tool into your wellness app to generate a soothing purple screen, perfect for meditation and mindfulness exercises. The serene color aids relaxation and mental wellbeing.",
        "Purple Screen for Lighting Effect": "Create a dynamic lighting effect with a full-screen purple display. Perfect for setting a unique ambience for your video calls, virtual events, or music sessions.",
        "Color Theory Study with Purple Screen": "Utilize a vibrant full-screen purple display as a learning tool for color theory. It helps art students and designers understand the impact and significance of color in their work.",
        "Display Testing with Purple Full Screen": "Check the color accuracy of your monitors or screens with our tool that generates a full-screen purple display. Essential for designers, photographers, and videographers.",
        "Interactive Purple Display for Children's Learning": "Engage children in interactive e-learning with a full-screen purple display. The bold color stimulates imagination and focus, enhancing the learning experience.",
        "purple screen to make a vibe": "I like the vibe purple gives",
        "purple screen to copy image": "To copy an image my classmate drew",
        "purple screen to make videos": "Because my YouTube videos are better with a purple screen",
        "purple screen for online calls": "For adding a purple glow during meeting.",
      },
      subTips: {
  ...
  },
  {
    ...
    tip: {
      title: "Lighting for zoom calls",
      content: {
        "Customized Lighting for Video Conferencing": "Use our zoom lighting screen tool to create the perfect lighting setup for your video calls. With adjustable color and temperature, you can achieve professional-level video conference lighting effortlessly.",
        "Photography Backdrop with Zoom Lighting Screen": "Enhance your photography setup with our adjustable zoom lighting screen. Adjust the color and temperature to suit the mood of your photoshoot and create stunning images.",
        "Improve eLearning Experience with Optimal Lighting": "With our zoom lighting screen, create a conducive learning environment for eLearning. Customizable light settings ensure optimal reading comfort and improved concentration.",
        "Web Developers Lighting Test Tool": "Web developers can use our full-screen zoom lighting screen to test how different light temperatures and colors affect the appearance of their designs, helping to create visually engaging and accessible websites.",
        "Color Therapy with Zoom Lighting Screen": "Therapists and wellness coaches can utilize our zoom lighting screen with adjustable color and temperature for color therapy sessions, promoting relaxation and healing.",
        "white screen as a lighting for zoom calls": "For video calls! I don't have a easy ring light, but do have two screens. So I can use one of the screens to light my face!",
        "Zoom Lighting to Get Brightness": "I use it to get brightness while i´m in a video call",
        "Zoom Lighting to Light Up": "To light up when I use videoconference calls",
        "Zoom Lighting to Turns My Monitor Into a Light": "Turns my monitor into a light to offset being backlit on video calls",
      },
    }
  },
  // Prank Screens
