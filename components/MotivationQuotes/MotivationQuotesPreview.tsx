...
const DEFAULT_PARAGRAPH = "The only way to do great work is to love what you do. If you haven't found it yet, keep looking. Don't settle."
...
export default function MotivationQuotesPreview({ 
  ...
  const displayParagraph = paragraph?.trim() === '' ? DEFAULT_PARAGRAPH : paragraph
