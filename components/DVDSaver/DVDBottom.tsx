...
const defaultRoutes = [
  ...
  { name: "Flip Clock", path: "/flip-clock-screensaver", icon: FlipClockIcon },
  { name: "Motivational Quote", path: "/motivational-quote-screensaver", icon: MotivationalQuoteIcon },
  { name: "No Signal", path: "/no-signal-smpte-color-bars-screensaver", icon: NoSignalIcon },
]
