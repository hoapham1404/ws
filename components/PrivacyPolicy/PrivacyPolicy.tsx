...
export default function PrivacyPolicy() {
  return (
    <div className=" mx-auto font-serif">
      ...
      <p className="mb-4 text-lg">By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
      ...
      <p className="mb-4 text-lg">We use the information we collect in various ways, including to:</p>
      ...
      <p className="mb-4 text-lg">
        ...
        <Link href="https://www.generateprivacypolicy.com/#cookies" className="text-primary hover:underline">
          the Cookies article on Generate Privacy Policy website
        </Link>
        .
      </p>

      <h2 className="text-3xl font-bold mt-8 mb-4">Google DoubleClick DART Cookie</h2>
      ...
      <p className="mb-4 text-lg">
        ...
        the following URL – <Link href="https://policies.google.com/technologies/ads" className="text-primary hover:underline">
      ...
      <p className="mb-4 text-lg">Under the CCPA, among other rights, California consumers have the right to:</p>
