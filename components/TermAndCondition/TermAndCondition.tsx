  ...
  return (
    <div className="font-serif">
      ...
      <p className="mb-4 text-lg">
        ...
        respect of provision of the Company&apos;s stated services, in accordance with and subject to, prevailing law of
      ...
      <p className="mb-4 text-lg">
        ...
        <Link href="https://www.termsandconditionstemplate.com" className="text-primary hover:underline">
      ...
      <p className="mb-4 text-lg">
        ...
        areas of the website. WhiteScreen does not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of WhiteScreen,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, WhiteScreen shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
        website.
      </p>

      <p className="mb-4 text-lg">
        WhiteScreen reserves the right to monitor all Comments and to remove any Comments which can be considered
        inappropriate, offensive or causes breach of these Terms and Conditions.
      </p>

      <p className="mb-4 text-lg">You warrant and represent that:</p>
      ...
      <p className="mb-4 text-lg">
        You hereby grant WhiteScreen a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p className="mb-4 text-lg">The following organizations may link to our Website without prior written approval:</p>

      <ul className="list-disc pl-8 mb-4 space-y-2">
        <li className="text-lg">Government agencies;</li>
        <li className="text-lg">Search engines;</li>
        <li className="text-lg">News organizations;</li>
        <li className="text-lg">
      ...
      <p className="mb-4 text-lg">We may consider and approve other link requests from the following types of organizations:</p>

      <ul className="list-disc pl-8 mb-4 space-y-2">
        <li className="text-lg">commonly-known consumer and/or business information sources;</li>
        <li className="text-lg">dot.com community sites;</li>
        <li className="text-lg">associations or other groups representing charities;</li>
        <li className="text-lg">online directory distributors;</li>
        <li className="text-lg">internet portals;</li>
        <li className="text-lg">accounting, law and consulting firms; and</li>
        <li className="text-lg">educational institutions and trade associations.</li>
      </ul>
      ...
      <p className="mb-4 text-lg">
        ...
        WhiteScreen; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p className="mb-4 text-lg">
        ...
        you must inform us by sending an e-mail to WhiteScreen. Please include your name, your organization name,
      ...
      <p className="mb-4 text-lg">Approved organizations may hyperlink to our Website as follows:</p>

      <ul className="list-disc pl-8 mb-4 space-y-2">
        <li className="text-lg">By use of our corporate name; or</li>
        <li className="text-lg">By use of the uniform resource locator being linked to; or</li>
        <li className="text-lg">
      ...
      <p className="mb-4 text-lg">
        No use of WhiteScreen&apos;s logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
      ...
      <ul className="list-disc pl-8 mb-4 space-y-2">
        <li className="text-lg">limit or exclude our or your liability for death or personal injury;</li>
        <li className="text-lg">limit or exclude our or your liability for fraud or fraudulent misrepresentation;</li>
        <li className="text-lg">limit any of our or your liabilities in any way that is not permitted under applicable law; or</li>
        <li className="text-lg">exclude any of our or your liabilities that may not be excluded under applicable law.</li>
      </ul>
