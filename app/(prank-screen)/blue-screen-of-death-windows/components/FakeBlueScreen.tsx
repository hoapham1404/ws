...
export default function FakeBlueScreen() {
  ...
  return (
    <div
      ...
      className={`${monoFont.className}   bg-[#004091] text-white h-full p-8 cursor-pointer ${isFullscreen ? 'fixed inset-0 z-50 flex items-center justify-center' : ''
        }`}
    >
      <div className={`${isFullscreen ? 'max-w-[80%] pt-[5%] text-2xl space-y-8' : 'text-[.52rem] space-y-3'}`}>
        <p>
        ...
        <p >
          ...
          as caching or shadowing. If you need to use Safe Mode to remove or disable components, restart your computer, press
        ...
        <p >*** SPCMDCON. SYS - Address FBFE7617 base at FBFE5000, Datestamp 3d6dd67c</p>
      </div>
    </div>
  )
}
